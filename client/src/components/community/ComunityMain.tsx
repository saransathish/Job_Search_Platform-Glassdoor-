...
//                         <input type="text" className='searchbowl' placeholder="Search for Bowls or conversations" />
//                     </div>
//                     <div className='mncm'>
...
//                         <button className='addcomm' onClick={handleAddComment}>Add Comment</button>
